...
func (in *BackendS3Spec) DeepCopyInto(out *BackendS3Spec) {
	*out = *in
	if in.AutoDetectOBC != nil {
		in, out := &in.AutoDetectOBC, &out.AutoDetectOBC
		*out = new(bool)
		**out = **in
	}
}
...
func (in *BackendTelemetrySpec) DeepCopy() *BackendTelemetrySpec {
	if in == nil {
		return nil
	}
	out := new(BackendTelemetrySpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkingSpec) DeepCopyInto(out *NetworkingSpec) {
	*out = *in
	...
	if in.ListenerSet != nil {
		in, out := &in.ListenerSet, &out.ListenerSet
		*out = new(ListenerSetSpec)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParentGatewayRef) DeepCopyInto(out *ParentGatewayRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParentGatewayRef.
func (in *ParentGatewayRef) DeepCopy() *ParentGatewayRef {
	if in == nil {
		return nil
	}
	out := new(ParentGatewayRef)
	in.DeepCopyInto(out)
	return out
}
